                ...
                <div className='md:hidden ml-5'>
                    ...
                    <div className='flex items-center gap-85'>
                        <div className='flex gap-8 text-gray-400 pb-10'>
                            <div><input type="radio" /></div>
                            <div>
                                <h4 className={`text-xl ${lightMode ? 'text-black' : 'text-white'} font-extrabold`}> Senior Web Developer</h4>
                                <p className='text-[#10B981] text-sm pb-3'>Global Tech Solutions • 2021 — Present</p>
                                <div className='mb-5'>
                                    <span className='text-gray-300 text-sm bg-slate-700 p-2 m-2 rounded-3xl'>Abuja</span>
                                </div>
                                <p className='text-sm'>Leading the core design team for a <br />SaaS platform used by over 1M+ users. Reduced user <br /> churn by 14%
                    ...
                    <div className='flex items-center gap-81'>
                        <div className='flex gap-8 text-gray-400 pb-10'>
                            ...
                            <div>
                                ...
                                <p className='text-[#10B981] text-sm pb-3'>Creative Agency X • 2018 — 2021</p>
                                <div className='mb-5'>
                                    <span className='text-gray-300 text-sm bg-slate-700 p-2 m-2 rounded-3xl'>Remote</span>
                                </div>
                                <p className='text-sm'>Collaborated with diverse clients from <br /> fintech to fashion. Delivered over 40+ <br /> high-fidelity prototypes and<br />
                                    successful MVPs.</p>
                            </div>
                        </div>
                    ...
                    <div className='flex items-center gap-82'>
                        <div className='flex  gap-8 text-gray-400 pb-10'>
                            ...
                            <div>
                                ...
                                <p className='text-[#10B981] text-sm pb-3'>Print & Digital Studio • 2016 — 2018</p>
                                <div className='mb-5'>
                                    <span className='text-gray-300 text-sm  bg-slate-700 p-2 m-2 rounded-3xl'>Lagos</span>
                                </div>
                                <p className='text-sm'>Focused on brand identity and <br /> typography. Learned the foundations <br />of visual hierarchy and color theory.</p>
                            </div>
                        </div>
